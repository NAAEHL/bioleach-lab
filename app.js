...
const THEMES = {
  ...
  light: {
    bg: "#f5f3ee", surface: "#fffdf9", surfaceHigh: "#ece8e0",
    border: "#ddd6c9", accent: "#2563a8", accentGlow: "rgba(37,99,168,0.10)",
    green: "#2a8a4d", yellow: "#a8730a", red: "#c4392a",
    muted: "#7a7567", text: "#2b2620", textDim: "#544e44",
  },
};
