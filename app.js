...
let C = THEMES.dark; // mutated by ThemeProvider at runtime; read at render time via getColors()
...
function App() {
  ...
  // Mutate the shared C object in place so every component (which reads C.xxx at render time) picks up the new theme
