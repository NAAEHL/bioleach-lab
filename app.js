...
const ICP_MIN = 1, ICP_MAX = 50;       // absolute machine detection range (used for alerts in ICP Analysis)
const TARGET_MIN = 1, TARGET_MID = 5, TARGET_MAX = 10; // recommended dilution target ("~1-10 ppm estimated")
...
function recommendDF(est) {
  ...
  // Target the middle of the recommended detection window (~5 ppm), not the upper machine limit (50 ppm)
        ...
        <div style={{ ...S.card, border:`1px solid ${C.accent}44` }}>
          ...
          <table style={S.table}>
            <thead><tr>
              ...
              <th style={S.th}>Target status (~1–10 ppm)</th>
            </tr></thead>
            <tbody>
